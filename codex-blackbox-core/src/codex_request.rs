...
mod tests {
    ...
    fn request_prompt_prefers_actual_task_after_codex_preamble() {
        ...
        assert_eq!(
            ...
            Some("CODEX_BLACKBOX marker actual prompt. Do not edit files.")
        );
    ...
    fn request_prompt_prefers_later_user_text_over_agents_text_part() {
          ...
          "input": [
            {
              ...
              "content": [
                ...
                {
                  "type": "input_text",
                  "text": "CODEX_BLACKBOX marker second text part. Do not edit files."
                }
              ]
            }
          ],
        ...
        assert_eq!(
            parsed.first_user_input.as_deref(),
            Some("CODEX_BLACKBOX marker second text part. Do not edit files.")
        );
        assert_eq!(parsed.cwd.as_deref(), Some("/repo"));
    }
}
